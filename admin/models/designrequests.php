...
class DesignRequestsModelDesignRequests extends JModelList
{
    ...
    /*protected function populateState($ordering = 'a.title', $direction = 'ASC')
    {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_designrequests');
    ...
    /*protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                'list.select',
                'a.id, a.title, a.alias, a.trello_card_id, a.checked_out, a.checked_out_time, a.created_by, a.state'
            )
        );
        $query->from($db->quoteName('#__designrequests', 'a'));
