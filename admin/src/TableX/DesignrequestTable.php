...
namespace NPEU\Component\Designrequests\Administrator\Table;
...
/**
 * Designrequest Table class.
 *
 * @since  1.0
 */
#class DesignrequestTable extends Nested implements VersionableTableInterface, TaggableTableInterface
class DesignrequestTable extends Table
{
    ...
    public function __construct(DatabaseDriver $db) {
        $this->typeAlias = 'com_designrequests.designrequest';

        parent::__construct('#__designrequests', 'id', $db);
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_designrequests.designrequest.'.(int) $this->$k;
    }
    /**
