...
<form action="<?php echo Route::_('index.php?option=com_designrequests&layout=edit&id=' . $this->item->id); ?>"
    method="post"
    name="adminForm"
    id="designrequest-form"
    class="form-validate">
    ...
    <?php echo implode("\n", $hidden_fields); ?>
    <input type="hidden" name="task" value="designrequest.edit" />
