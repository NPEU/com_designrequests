...
<div class="l-box  l-box--space--edge">
    <p>
        <a href="<?php echo Route::_('index.php?option=com_designrequests&view=designrequest&task=designrequest.edit&id=' . $this->item->id); ?>" class="u-space--left--s">
            <span><?php echo Text::_('COM_DESIGNREQUESTS_RECORDS_ACTION_EDIT'); ?></span>
        ...
        <div class="l-layout__inner">
            ...
            <p class="l-box l-layout  l-row  l-gutter  l-flush-edge-gutter">
                <span class="l-layout__inner  c-utilitext">
                    <span class="l-box">
                        <a href="<?php echo Route::_('index.php?option=com_designrequests'); ?>">
                    ...
                    <span class="l-box u-text-align--right">
                        <a href="<?php echo Route::_('index.php?option=com_designrequests&task=designrequest.edit&id=' . $this->item->id); ?>" class="u-space--left--s">
                            <span><?php echo Text::_('COM_DESIGNREQUESTS_RECORDS_ACTION_EDIT'); ?></span>
                            <svg focusable="false" aria-hidden="true" width="1.25em" height="1.25em" display="none"><use xlink:href="#icon-edit"></use></svg>
                        </a>
                    </span>
