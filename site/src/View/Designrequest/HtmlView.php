...
namespace NPEU\Component\Designrequests\Site\View\Designrequest;
...
class HtmlView extends BaseHtmlView {
    ...
    public function display($template = null)
    {
        ...
        #echo '<pre>'; var_dump(array_keys($this->form->getFieldset('main'))); echo '</pre>'; exit;
        ...
        if (!$is_new && ($user_string_id == $this->item->customFieldItemsKey['requested_by']->realvalue)) {
            $is_own = true;
        }
        ...
        if ($is_new) {
            $breadcrumb_title  = Text::_('COM_DESIGNREQUESTS_PAGE_TITLE_ADD_NEW');
        } else {
        ...
        // 'index.php?option=com_designrequests&view=designrequests&Itemid=xxx' )
        ...
        */
        ...
        if ($input->get('layout') == 'edit') {
            $document->page_heading_additional = ': ' . (
              ...
              : Text::_('COM_DESIGNREQUESTS_RECORD_EDITING') . ' ' . $this->item->name
            );
        } else {
            $document->page_heading_additional = ': ' . $this->item->name;
        }
